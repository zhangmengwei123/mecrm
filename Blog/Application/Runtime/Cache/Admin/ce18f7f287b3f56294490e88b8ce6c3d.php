            ...
            <div class="page-content">
                <div class="row">
                    ...
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" action="<?php echo U('Label/label_update_do');?>" method="post">
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 标签名 </label>

                                <div class="col-sm-9">
                                    <input type="hidden" name="l_id" value="<?php echo ($arr["l_id"]); ?>"/>
                                    <input type="text" name='name' id="form-field-1" class="col-xs-10 col-sm-5" value="<?php echo ($arr["l_name"]); ?>"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <?php if(($arr['l_show'] == 1)): ?><input type="radio" name="show" value="1" checked/>展示
