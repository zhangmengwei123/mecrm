				...
				<div class="main-content">
					...
					<div class="page-content">
							<div class="row">
									...
									<form class="form-horizontal" role="form" action="<?php echo U('Article/article_update_do');?>" method="post">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 文章标题 </label>

										<div class="col-sm-9">
                                            <input type="hidden" name="article_id" value="<?php echo ($arr["a_id"]); ?>"/>
											<input type="text" id="form-field-1" placeholder="标题" class="col-xs-10 col-sm-5" name="title" value="<?php echo ($arr["a_title"]); ?>"/>
										</div>
									</div>
									...
									<div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea id="editor" style="width: 500px; height: 300px;" name="content"><?php echo ($arr["a_content"]); ?></textarea>
									...
									<div class="form-group">
														...
														<div class="col-sm-9">
															<select name="cate_id">
                                                                <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i; if($arr['c_id'] == $v['c_id']): ?><option value="<?php echo ($v["c_id"]); ?>" selected><?php echo ($v["c_name"]); ?></option>
                                                                    <?php else: ?>
                                                                        <option value="<?php echo ($v["c_id"]); ?>"><?php echo ($v["c_name"]); ?></option><?php endif; endforeach; endif; else: echo "" ;endif; ?>
															</select>
															</div>
									</div>
									...
									<div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <?php if(is_array($label_data)): $i = 0; $__LIST__ = $label_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i; if($v['flag'] == 1): ?><input type="checkbox" value="<?php echo ($v["l_id"]); ?>" name="l_id[]" checked/><?php echo ($v["l_name"]); ?>
                                                <?php else: ?>
                                                    <input type="checkbox" value="<?php echo ($v["l_id"]); ?>" name="l_id[]" /><?php echo ($v["l_name"]); endif; endforeach; endif; else: echo "" ;endif; ?>
                                        </div>
									</div>
