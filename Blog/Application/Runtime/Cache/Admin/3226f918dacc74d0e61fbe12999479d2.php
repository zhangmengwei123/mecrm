                        ...
                        <div class="table-responsive">
                            <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                ...
                                <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td><?php echo (date("Y/m/d",$v["t_time"])); ?></td>
                                        <td>
                                            <a href="<?php echo U('Admin/admin_update',array('id'=>$v['id']));?>" class="btn">编辑</a>
...
<script>
    function page(p) {
        ...
        var url = "<?php echo U('Admin/admin_page');?>?p=" + p + "&sou=" + sou;
...
//                console.log(xhr.responseText)
                ...
                for (var i in info['data']) {
                    var date= new Date(info['data'][i]['t_time']*1000);
                    var t_time=date.getFullYear() + "-" + (date.getMonth() + 1) + "-" + date.getDate()

                    _str += "<tr>" +
                            "<td>" + info['data'][i]['id'] + "</td>" +
                            "<td>" + info['data'][i]['account'] + "</td>" +
                            "<td>" + info['data'][i]['tel'] + "</td>" +
                            "<td>" + t_time + "</td>"+
                            "<td><a href="+"<?php echo U('Admin/admin_update');?>?id="+info['data'][i]['id']+" class='btn'>编辑</a> <a href='javascript:;'  class='btn btn-danger'>删除</a></td>" +
                            "</tr>"
                }
