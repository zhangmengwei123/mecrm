...
<![endif]-->
    ...
    <ul class="nav nav-list">
        ...
        <li>
            ...
            <ul class="submenu">
                <li>
                    <a href="<?php echo U('System/system');?>">
                        <i class="icon-double-angle-right"></i>
                        设置
                    </a>
                </li>
				...
				<div class="main-content">
					...
					<div class="page-content">
							<div class="row">
									...
									<form class="form-horizontal" action="<?php echo U('System/system_do');?>" method="post">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 网站名称 </label>

										<div class="col-sm-9">
											<input type="text" name="WEB_NAME"  id="form-field-1" placeholder="网站名称" value="<?php echo (C("WEB_NAME")); ?>"class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="WEB_URL" value="<?php echo (C("WEB_URL")); ?>"   id="form-field-2" placeholder="网站网址" class="col-xs-10 col-sm-5" />
										</div>
									</div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="WEB_COPRIGHT" value="<?php echo (C("WEB_COPRIGHT")); ?>"  id="form-field-2" placeholder="版权" class="col-xs-10 col-sm-5" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="WEB_RODE" value="<?php echo (C("WEB_RODE")); ?>"  id="form-field-2" placeholder="备案号" class="col-xs-10 col-sm-5" />
                                        </div>
                                    </div>
