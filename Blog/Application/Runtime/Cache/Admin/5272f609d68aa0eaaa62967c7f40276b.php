        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <form class="form-horizontal" role="form" action="<?php echo U('System/system_do');?>" method="post">
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 网站名称 </label>

                            <div class="col-sm-9">
                                <input type="text" name="WEB_NAME" id="form-field-1"  class="col-xs-10 col-sm-5" value="<?php echo (C("WEB_NAME")); ?>"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-2"> 网站网址 </label>

                            <div class="col-sm-9">
                                <input type="text" name="WEB_URL" id="form-field-2"  class="col-xs-10 col-sm-5" value="<?php echo (C("WEB_URL")); ?>"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-2"> 版权 </label>

                            <div class="col-sm-9">
                                <input type="text" name="WEB_COPYRIGHT" id="form-field"  class="col-xs-10 col-sm-5" value="<?php echo (C("WEB_COPYRIGHT")); ?>"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-2"> 备案号 </label>

                            <div class="col-sm-9">
                                <input type="text" name="WEB_RECORD" id="form-field1"  class="col-xs-10 col-sm-5" value="<?php echo (C("WEB_RECORD")); ?>"/>
                            </div>
                        </div>
...
<script src="/Blog/Public/Admin/assets/js/jquery.slimscroll.min.js"></script>
<script src="/Blog/Public/Admin/assets/js/jquery.easy-pie-chart.min.js"></script>
<script src="/Blog/Public/Admin/assets/js/jquery.sparkline.min.js"></script>
<script src="/Blog/Public/Admin/assets/js/flot/jquery.flot.min.js"></script>
<script src="/Blog/Public/Admin/assets/js/flot/jquery.flot.pie.min.js"></script>
<script src="/Blog/Public/Admin/assets/js/flot/jquery.flot.resize.min.js"></script>
