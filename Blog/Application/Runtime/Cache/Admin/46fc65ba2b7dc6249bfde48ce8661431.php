					...
					<div class="page-content">
							<div class="row">
									...
									<div class="col-xs-12">
                                        ...
                                        <form action="<?php echo U('Category/category_list');?>" method="get">
                                            请输入类名<input type="text" name="name" value="<?php echo ($arr["name"]); ?>"/>
                                            是否展示<select name="leve">
                                                <?php if(($arr['leve'] == 1)): ?><option value="">请选择</option>
                                                    <option value="1" selected>是</option>
                                                    <option value="2">否</option>
                                                <?php elseif($arr['leve'] == 2): ?>
                                            ...
                                            <input type="submit" value="搜索"  class="btn" style="background-color: #9baab3;margin-bottom: 10px;border: 0px;margin-left: 20px;color: #ffffff;width:70px;height: 30px;border-radius:5%"/>
                                        </form>
										<div class="table-responsive">
											<table id="sample-table-1" class="table table-striped table-bordered table-hover" style="font-size: 14px">
												<thead>
													<tr>
														<th>分类id</th>
														<th>分类名</th>
												...
												<tbody>
                                                <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>

														<td><?php echo ($v["c_id"]); ?></td>
														<td><?php echo ($v["c_name"]); ?></td>
														<td><?php echo ($v["c_man"]); ?></td>
														<td><?php echo (date("Y/m/d",$v["c_time"])); ?></td>
														<td><?php echo ($v["c_leve"]); ?></td>
                                                        <?php if(($v['c_show']==1)): ?><td>是</td>
                                                        <?php else: ?>
                                                            <td>否</td><?php endif; ?>
														<td>
                                                            <a href="<?php echo U('Category/category_update',array('id'=>$v['c_id']));?>" class="btn"  style="border-radius:5%">编辑</a>
                                                            <a href="#" class="btn btn-danger" style="border-radius:5%">删除</a>
														</td>
