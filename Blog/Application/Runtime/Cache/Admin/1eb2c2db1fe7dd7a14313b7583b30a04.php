            ...
            <div class="page-content">
                <div class="row">
                    ...
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" action="<?php echo U('Link/link_update_do');?>" method="post">
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 网站名称 </label>

                                <div class="col-sm-9">
                                    <input type="hidden" name="l_id" value="<?php echo ($arr['id']); ?>"/>
                                    <input type="text" name='name' id="form-field-1" placeholder="网站名称" class="col-xs-10 col-sm-5" value="<?php echo ($arr['account']); ?>"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name='rl' id="form-field-1" placeholder="地址" class="col-xs-10 col-sm-5" value="<?php echo ($arr['url']); ?>"/>
                                </div>
                            </div>
