            ...
            <div class="page-content">
                <div class="row">
                    ...
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" action="<?php echo U('Category/category_update_do');?>" method="post">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <input type="text" name='name' id="form-field-1" class="col-xs-10 col-sm-5" value="<?php echo ($arr["c_name"]); ?>"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <?php if(($arr['c_show'] == 1)): ?><input type="radio" name="show" value="1" checked/>展示
                                        <input type="radio" name="show" value="2"/>不展示
                                    <?php else: ?>
                                        <input type="radio" name="show" value="1" />展示
                                        <input type="radio" name="show" value="2" checked/>不展示<?php endif; ?>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-2"> 排序(权重) </label>

                                <div class="col-sm-9">
                                    <input type="text" id="form-field-4" class="col-xs-10 col-sm-5" name="leve" value="<?php echo ($arr["c_leve"]); ?>"/>
                                </div>
                            </div>
