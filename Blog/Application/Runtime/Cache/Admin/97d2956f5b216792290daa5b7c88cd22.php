				...
				<div class="main-content">
					...
					<div class="page-content">
							<div class="row">
									...
									<form class="form-horizontal" action="<?php echo U('Category/category_add');?>" method="post">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 分类名 </label>

										<div class="col-sm-9">
											<input type="text" name='name' id="form-field-1" placeholder="分类名" class="col-xs-10 col-sm-5" />
										</div>
									</div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" id="form-field-4" placeholder="1-100" class="col-xs-10 col-sm-5" name="leve"/>
                                            </div>
                                        </div>
