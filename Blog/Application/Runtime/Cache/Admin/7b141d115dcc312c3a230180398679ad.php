            ...
            <div class="page-content">
                <div class="row">
                    ...
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" action="<?php echo U('Admin/admin_update_do');?>" method="post">
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 管理员账号 </label>

                                <div class="col-sm-9">
                                    <input type="hidden" name="admin_id" value="<?php echo ($arr["id"]); ?>"/>
                                    <input type="text" name="name" id="form-field-1" class="col-xs-10 col-sm-5" value="<?php echo ($arr["account"]); ?>"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="password" name="pwd1" id="form-field-2" placeholder="密码" class="col-xs-10 col-sm-5" value="<?php echo ($arr["pwd"]); ?>"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="phone" id="form-field-2" placeholder="手机号" class="col-xs-10 col-sm-5" value="<?php echo ($arr["tel"]); ?>"/>
                                </div>
                            </div>
