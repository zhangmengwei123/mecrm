            ...
            <div class="page-content">
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form action="<?php echo U('Label/label_list');?>" method="post">
                        ...
                        <div class="table-responsive">
                            <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                ...
                                <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td><?php echo ($v["l_man"]); ?></td>
                                        <td><?php echo (date("Y/m/d",$v["l_time"])); ?></td>
                                        <?php if(($v['l_show']==1)): ?><td>是</td>
                                            <?php else: ?>
                                            <td>否</td><?php endif; ?>
                                        <td>
                                            <a href="<?php echo U('Label/label_update',array('id'=>$v['l_id']));?>" class="btn">编辑</a>
...
<script>
    function page(p) {
        ...
        var url = "<?php echo U('Label/label_page');?>?p=" + p + "&sou=" + sou;
...
//                console.log(xhr.responseText)
                ...
                for (var i in info['data']) {
                    if(info['data'][i]['l_show']=='1'){
                        show='是';
                    }else{
                        show='否';
                    }
                    var date= new Date(info['data'][i]['l_time']*1000);
                    var l_time=date.getFullYear() + "-" + (date.getMonth() + 1) + "-" + date.getDate() + "- " + date.getHours() + ":" + date.getMinutes() + ":" + date.getSeconds();

                    _str += "<tr>" +
                            "<td>" + info['data'][i]['l_id'] + "</td>" +
                            "<td>" + info['data'][i]['l_name'] + "</td>" +
                            "<td>" + info['data'][i]['l_man'] + "</td>" +
                            "<td>" + l_time + "</td>" +
                            "<td>"+show+"</td>"+
                            "<td><a href="+"<?php echo U('Label/label_update');?>?id="+info['data'][i]['l_id']+" class='btn'>编辑</a> <a href='javascript:;'  class='btn btn-danger'>删除</a></td>" +
                            "</tr>"
                }
