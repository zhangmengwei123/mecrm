											...
											<table id="sample-table-1" class="table table-striped table-bordered table-hover">
												...
												<tbody>
                                                    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
														...
														<td><?php echo (htmlspecialchars_decode($v["a_content"])); ?></td>
														...
														<td>
                                                            <a href="<?php echo U('Article/article_update',array('id'=>$v['a_id']));?>" class="btn">编辑</a>
                                                            <a href="<?php echo U('Article/article_delete',array('id'=>$v['a_id']));?>" class="btn btn-danger">删除</a>
														</td>

													</tr><?php endforeach; endif; else: echo "" ;endif; ?>
												</tbody>
											</table>
                                           <div align="center"><?php echo ($show); ?></div>
