    ...
    <div class="blogs">
        <div id="index_view">
            ...
            <ul>
                ...
                <p><img src="/Blog/Public/index/images/post1.jpg"></p>
            ...
            <div class="share">
                ...
                <script type="text/javascript">
                    document.getElementById("bdshell_js").src = "http://bdimg.share.baidu.com/static//Blog/Public/index/js/shell_v2.js?cdnversion=" + Math.ceil(new Date()/3600000)
                </script>
                <!-- Baidu Button END -->
            </div>
            <div class="otherlink">
        ...
        <aside>
            ...
            <div class="toppic">
                <h2>图文并茂</h2>
                <ul>
                    <li><a href="/"><img src="/Blog/Public/index/images/k01.jpg">腐女不可怕，就怕腐女会画画！
                        <p>伤不起</p>
                    </a></li>
                    <li><a href="/"><img src="/Blog/Public/index/images/k02.jpg">问前任，你还爱我吗？无限戳中泪点~
                        <p>感兴趣</p>
                    </a></li>
                    <li><a href="/"><img src="/Blog/Public/index/images/k03.jpg">世上所谓幸福，就是一个笨蛋遇到一个傻瓜。
                        <p>喜欢</p>
                    </a></li>
                </ul>
            </div>
